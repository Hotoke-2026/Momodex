...
function App() {
  ...
  return (
    <div className="min-h-screen bg-(--color-base) text-(--color-text) pb-20">
      ...
      <section className="bg-(--color-surface) border-b border-(--color-tan)/30 py-12 px-6 sm:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="text-sm text-(--color-text-soft) mt-2 leading-relaxed">
              New Zealand's long isolation produced unique ecosystems. Over 80% of native insects, birds, and plants are found nowhere else on Earth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl border border-(--color-tan)/40 bg-(--color-base)/50 flex flex-col gap-3">
              ...
              <h3 className="font-bold text-base text-(--color-text)">Predator Control</h3>
              <p className="text-xs text-(--color-text-soft) leading-relaxed">
                Introduced pests like possums, rats, and stoats threaten native wildlife. Active predator management protects breeding grounds across millions of hectares.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-(--color-tan)/40 bg-(--color-base)/50 flex flex-col gap-3">
              ...
              <h3 className="font-bold text-base text-(--color-text)">Endemic Species</h3>
              <p className="text-xs text-(--color-text-soft) leading-relaxed">
                From the flightless Kākāpō to ancient Tuatara, Aotearoa’s flora and fauna require ongoing sanctuary management to rebound and thrive.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-(--color-tan)/40 bg-(--color-base)/50 flex flex-col gap-3">
              ...
              <h3 className="font-bold text-base text-(--color-text)">Community Logging</h3>
              <p className="text-xs text-(--color-text-soft) leading-relaxed">
                Logging species observations helps map distribution networks, identify biodiversity corridors, and directly support localized conservation.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* --- GROUNDED STEP-BY-STEP FIELD OBSERVATION SECTION --- */}
      <section id="observation-form" className="py-16 border-b border-(--color-tan)/30 bg-(--color-base)/30">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="relative pl-10 sm:pl-12">
              ...
              <div className="flex flex-col gap-2">
                <div>
                  <h3 className="text-sm font-bold text-(--color-text)">Select Observation Photo</h3>
            ...
            <div className="relative pl-10 sm:pl-12">
              ...
              <div className="flex flex-col gap-2">
                <div>
                  <h3 className="text-sm font-bold text-(--color-text)">Add Location Context</h3>
                  <p className="text-xs text-(--color-text-soft)">Specify where you spotted this species (optional).</p>
                </div>
